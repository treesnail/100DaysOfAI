...
class TestPromptConstants:
    ...
    def test_the_current_prompt_is_v1(self) -> None:
        """``RAG_ANSWER_PROMPT`` 必须**指向**首版（改版时新增 _V2 并指过去）."""
        assert RAG_ANSWER_PROMPT is RAG_ANSWER_PROMPT_V1
        assert RAG_ANSWER_PROMPT_VERSION == "v1"
